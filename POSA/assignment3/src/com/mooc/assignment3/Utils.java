...
public class Utils {
    ...
    public static Uri grayScaleFilter(Context context,
        ...
        for (int i = 0; i < height; ++i) {
            for (int j = 0; j < width; ++j) {
                ...
                if(po != null)
                	po.update(width*height, i * width + j);
            }
        }
    ...
    public static Bitmap decodeSampledBitmap(Uri imageFile, int sampleSize) {
        ...
        return BitmapFactory.decodeFile(imageFile.toString(), options);
    }
